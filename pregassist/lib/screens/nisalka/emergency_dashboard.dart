...
class _EmergencyDashboardState extends State<EmergencyDashboard> {
  ...
  // --- NEW: Load history from SharedPreferences ---
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        // --- NEW SCROLLABLE BODY ---
        // UPDATED: Wrapped in RefreshIndicator for Pull-to-Refresh
        body: RefreshIndicator(
          onRefresh: _loadHistory,
          color: const Color(0xFF193CB8), // Matches your theme color
          child: SingleChildScrollView(
            // UPDATED: Added AlwaysScrollableScrollPhysics so you can pull-to-refresh even if the list is empty
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          // Refresh history when coming back from Diagnosis Wizard
                          _loadHistory();
                        });
                      },
                      child: Column(
                ...
                // 5. HISTORY BOXES (DYNAMICALLY LOADED)
                if (_historyList.isEmpty)
                  const Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text("No recent history available.", style: TextStyle(color: Colors.grey)),
                  ),

                ..._historyList.map((entry) {
                  return Column(
                    children: [
                      _buildHistoryBox(entry['title'] ?? 'Unknown', entry['date'] ?? ''),
