  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Padding(
          padding: EdgeInsets.only(left: 10.0), // Added spacing
          child: Text(
            "Maternal Dashboard",
            style: TextStyle(
              fontSize: 20,
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          padding: const EdgeInsets.fromLTRB(20, 120, 20, 120), // Increased top padding to fix overlap
          child: Column(
            children: [
              Container(
                height: 150, // Slightly larger to fit the image nicely
                width: 150,
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: const EdgeInsets.only(bottom: 4, top: 4), // Reduced padding inside card
          isDense: true,
        ),
      ),
    );
